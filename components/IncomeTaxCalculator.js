            ...
            <div className="tab-content">
              ...
              {salaryTaxResult && (
                <div className="results-container">
                  ...
                  <PieBreakdownChart
                    title="Take-home vs tax split"
                    items={[
                      { label: 'Net salary', value: salaryTaxResult.netSalary, color: '#10b981' },
                      { label: 'Total tax', value: salaryTaxResult.totalTax, color: '#f97316' }
                    ]}
            ...
            <div className="tab-content">
              ...
              {businessTaxResult && (
                <div className="results-container">
                  ...
                  <PieBreakdownChart
                    title="Business income distribution"
                    items={[
                      { label: 'Expenses', value: businessTaxResult.totalExpenses, color: '#f59e0b' },
                      { label: 'Total tax', value: businessTaxResult.totalTax, color: '#ef4444' },
                      { label: 'Profit after tax', value: Math.max(0, businessTaxResult.netProfit - businessTaxResult.totalTax), color: '#22c55e' }
                    ]}
                    formatter={formatCurrency}
                  />
                  <ResultActions
                ...
                <div className="comparison-calculator">
                  ...
                  {comparisonResult && (
                    <div className="comparison-results">
                      ...
                      <ComparisonBars
                        title="Regime tax comparison"
                        items={[
                          { label: 'Old regime tax', value: comparisonResult.oldRegimeTax, color: '#f97316' },
                          { label: 'New regime tax', value: comparisonResult.newRegimeTax, color: '#3b82f6' }
                        ]}
                        formatter={formatCurrency}
                      />
                      <ResultActions
