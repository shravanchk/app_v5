...
import { IndianRupee, DollarSign, Euro, Wrench, HeartPulse, ArrowRight, LucideIcon } from 'lucide-react';
...
const REGIONS: Region[] = [
  ...
  { icon: HeartPulse, label: 'Health & Fitness', href: '/health-calculators', blurb: 'BMI, calorie needs, BMR, body fat, period and pregnancy due date.', tint: 'bg-rose-50 text-rose-600 dark:bg-rose-900/30 dark:text-rose-300' },
