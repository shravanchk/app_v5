        ...
        <article className="mt-10 space-y-8 text-sm leading-relaxed text-ink-soft dark:text-slate-300">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-1.5 pl-5">
              <li><a href="/debt-payoff-calculator" className="font-medium text-brand-600 underline underline-offset-2 hover:text-brand-700 dark:text-brand-300">Juggling several debts? Compare snowball vs avalanche in the Debt Payoff Calculator</a></li>
