...
const TatkalChargesCalculator = () => {
  ...
  const softwareSchema = buildSoftwareApplicationSchema({
    ...
    url: 'https://upaman.com/tatkal-charges-calculator',
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    { name: 'Tatkal Charges Calculator', item: 'https://upaman.com/tatkal-charges-calculator' }
  ]);

  return (
    <>
      <Head>
        <title>Tatkal Charges Calculator — Extra Cost of Tatkal Tickets | Upaman</title>
        ...
        <link rel="canonical" href="https://upaman.com/tatkal-charges-calculator" />
        <meta property="og:title" content="Tatkal Charges Calculator | Upaman" />
        ...
        <meta property="og:url" content="https://upaman.com/tatkal-charges-calculator" />
