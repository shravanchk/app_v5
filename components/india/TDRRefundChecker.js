...
const TDRRefundChecker = () => {
  ...
  const softwareSchema = buildSoftwareApplicationSchema({
    ...
    url: 'https://upaman.com/tdr-refund-checker',
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    { name: 'TDR Refund Checker', item: 'https://upaman.com/tdr-refund-checker' }
  ]);

  return (
    <>
      <Head>
        <title>TDR Refund Checker — Am I Eligible for an IRCTC Refund? | Upaman</title>
        ...
        <link rel="canonical" href="https://upaman.com/tdr-refund-checker" />
        <meta property="og:title" content="TDR Refund Eligibility Checker | Upaman" />
        ...
        <meta property="og:url" content="https://upaman.com/tdr-refund-checker" />
