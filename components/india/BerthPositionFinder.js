...
const BerthPositionFinder = () => {
  ...
  const softwareSchema = buildSoftwareApplicationSchema({
    ...
    url: 'https://upaman.com/berth-position-finder',
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    { name: 'Berth Position Finder', item: 'https://upaman.com/berth-position-finder' }
  ]);

  return (
    <>
      <Head>
        <title>Train Berth Position Finder — Lower, Middle, Upper or Side? | Upaman</title>
        ...
        <link rel="canonical" href="https://upaman.com/berth-position-finder" />
        <meta property="og:title" content="Train Berth Position Finder | Upaman" />
        ...
        <meta property="og:url" content="https://upaman.com/berth-position-finder" />
