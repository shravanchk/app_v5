...
const IRCTCCancellationCalculator = () => {
  ...
  const softwareSchema = buildSoftwareApplicationSchema({
    ...
    url: 'https://upaman.com/irctc-cancellation-calculator',
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    { name: 'IRCTC Cancellation Calculator', item: 'https://upaman.com/irctc-cancellation-calculator' }
  ]);
  ...
  return (
    <>
      <Head>
        <title>IRCTC Cancellation Charges Calculator — April 2026 Refund Rules | Upaman</title>
        ...
        <link rel="canonical" href="https://upaman.com/irctc-cancellation-calculator" />
        <meta property="og:title" content="IRCTC Cancellation Charges Calculator — April 2026 Rules | Upaman" />
        ...
        <meta property="og:url" content="https://upaman.com/irctc-cancellation-calculator" />
