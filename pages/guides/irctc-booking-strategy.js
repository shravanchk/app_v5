...
const articleSchema = {
  ...
  mainEntityOfPage: 'https://upaman.com/guides/irctc-booking-strategy'
};
...
export default function IrctcBookingStrategyGuide() {
  return (
    ...
    >
      ...
      <h2 style={sectionTitleStyle}>How to use Upaman tools together</h2>
      <Callout>
        <ol>
          ...
          <li>Review assumptions on the <a href="/methodology">Methodology page</a>.</li>
        </ol>
      </Callout>
